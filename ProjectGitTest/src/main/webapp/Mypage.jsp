		...
		<div class="container-fluid">
			<div class="row h-100 align-items-center justify-content-center"
				...
				<div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
					<div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3" style="text-align: center;">
						<div
						...
						<div class="col-sm-12 col-xl-6">
							<div class="bg-secondary rounded h-100 p-4">
								<dl class="row mb-0">
									...
									<dd class="col-sm-8">장향미</dd>

									<dt class="col-sm-4">나이</dt>
									<dd class="col-sm-8">23425656세</dd>

									<dt class="col-sm-4 text-truncate">연봉</dt>
									<dd class="col-sm-8">1억원 이상</dd>
									
									<dt class="col-sm-4">세대원 수</dt>
									<dd class="col-sm-8">3명</dd>
